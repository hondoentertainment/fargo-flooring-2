        ...
        <div className="social-footer">
          <div className="social-partner">
            {formData.partnerLogo && (
              <img src={formData.partnerLogo} alt={`${formData.partnerName || 'Partner'} Logo`} className="partner-logo" style={{ maxHeight: '60px', maxWidth: '120px', objectFit: 'contain', marginBottom: '10px' }} />
            )}
